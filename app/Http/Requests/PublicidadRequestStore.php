...
class PublicidadRequestStore extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
             ...
             'intermedia' => 'required|image|mimes:jpeg,png,jpg,gif,svg|max:3048',
    ...
    public function messages()
    {
        return [
            ...
            'intermedia.required' => 'Seleccione una imágen',
